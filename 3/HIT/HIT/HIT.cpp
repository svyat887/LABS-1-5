// HIT.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main() // тіло програми
{
    ...
    float x0=7, y0=7, R0=5, x1, y1;
   
    
    cout << "Введи координати точки А" << endl;
    cout << "x1 = "; cin >> x1;
    cout << "y1 = "; cin >> y1;
    cout << "Точка А: " << "(" << x1 << ";" << y1 << ")" << endl;
    ...
    {
        cout << "Точка A (" << x1 << ";" << y1 << ") НЕ потрапляє в коло з центром (" << x0 << ";" << y0 << ")  і радіусом " << R0 << "." << endl;
    }
    system("pause");
}
