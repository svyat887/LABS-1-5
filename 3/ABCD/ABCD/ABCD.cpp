...
int main() // тіло програми
{
    ...
    int A, B, C, D, ten;
    cout << "Введи значення змінних А, B, C і D:" << endl;
    cout << "A = ";  cin >> A;
    cout << "B = ";  cin >> B;
    cout << "C = ";  cin >> C;
    cout << "D = ";  cin >> D;
    cout << "A = " << A << "\t B = " << B << "\t C = " << C << "\t D = " << D << endl;
    if (A > B) { ten = A; A = B; B = ten; } //умова
    if (A > C) { ten = A; A = C; C = ten; }//умова
    if (A > D) { ten = A; A = D; D = ten; } //умова
    if (B > C) { ten = B; B = C; C = ten; } //умова
    if (B > D) { ten = B; B = D; D = ten; } //умова
    if (C > D) { ten = C; C = D; D = ten; } //умова
    cout << "A = " << A << "\t B = " << B << "\t C = " << C << "\t D = " << D << endl;
    system("pause");
}
