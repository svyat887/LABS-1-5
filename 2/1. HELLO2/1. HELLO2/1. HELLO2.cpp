// 1. HELLO2.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main() // тіло програми
{
    ...
    char you[21]; // змінна, що прийме значення імені
    std::cout << "Як тебе звати?\n"; //output
    std::cin >> you; //input
    std::cout << "Приємно познайомитися, " << you << "!\n"; //output
    system("pause");
}
